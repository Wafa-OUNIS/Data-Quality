...
package qd_projet.metadatacompletude_0_1;
...
/**
 * Job: MetaDataCompletude Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class MetaDataCompletude implements TalendJob {
	...
	private final String jobName = "MetaDataCompletude";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					MetaDataCompletude.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(MetaDataCompletude.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
		final static byte[] commonByteArrayLock_QD_PROJET_MetaDataCompletude = new byte[0];
		static byte[] commonByteArray_QD_PROJET_MetaDataCompletude = new byte[0];

		public Double nbrcomplet;

		public Double getNbrcomplet() {
			return this.nbrcomplet;
		}

		public void readData(ObjectInputStream dis) {

			synchronized (commonByteArrayLock_QD_PROJET_MetaDataCompletude) {
				...
				try {
					...
					length = dis.readByte();
					if (length == -1) {
						this.nbrcomplet = null;
					} else {
						this.nbrcomplet = dis.readDouble();
					}
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				if (this.nbrcomplet == null) {
					dos.writeByte(-1);
				} else {
					dos.writeByte(0);
					dos.writeDouble(this.nbrcomplet);
				}
		...
		public String toString() {
			...
			sb.append("[");
			sb.append("nbrcomplet=" + String.valueOf(nbrcomplet));
			sb.append("]");
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_QD_PROJET_MetaDataCompletude.length) {
					if (length < 1024 && commonByteArray_QD_PROJET_MetaDataCompletude.length == 0) {
						commonByteArray_QD_PROJET_MetaDataCompletude = new byte[1024];
					} else {
						commonByteArray_QD_PROJET_MetaDataCompletude = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_QD_PROJET_MetaDataCompletude, 0, length);
				strReturn = new String(commonByteArray_QD_PROJET_MetaDataCompletude, 0, length, utf8Charset);
			}
			return strReturn;
		}
...
// ------------
				...
				Object source_tFileInputExcel_1 = "C:/Users/ElectroTec/Desktop/Nouveau dossier/detectCompletude.xls";
...
// Start of branch "row1"
							if (row1 != null) {
								...
								operation_result_tAggregateRow_1.nbrcomplet_clmCount++;
				...
				for (AggOperationStruct_tAggregateRow_1 aggregated_row_tAggregateRow_1 : values_tAggregateRow_1) { // G_AggR_600
					...
					row4.nbrcomplet = (double) aggregated_row_tAggregateRow_1.count;
					row4.nbrcomplet = (double) aggregated_row_tAggregateRow_1.nbrcomplet_clmCount;
					...
					row4_HashRow.nbrcomplet = row4.nbrcomplet;
	...
	public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
		...
		public Double nbrincomplet;

		public Double getNbrincomplet() {
			return this.nbrincomplet;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_QD_PROJET_MetaDataCompletude) {
				...
				try {
					...
					length = dis.readByte();
					if (length == -1) {
						this.nbrincomplet = null;
					} else {
						this.nbrincomplet = dis.readDouble();
					}
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				if (this.nbrincomplet == null) {
					dos.writeByte(-1);
				} else {
					dos.writeByte(0);
					dos.writeDouble(this.nbrincomplet);
				}
		...
		public String toString() {
			...
			sb.append(super.toString());
			sb.append("[");
			sb.append("nbrincomplet=" + String.valueOf(nbrincomplet));
			sb.append("]");
...
// ------------
				...
				Object source_tFileInputExcel_2 = "C:/Users/ElectroTec/Desktop/Nouveau dossier/RejectCompletude.xls";
...
// Start of branch "row2"
							if (row2 != null) {
								...
								operation_result_tAggregateRow_2.nbrincomplet_clmCount++;
...
// ###############################
				...
				for (AggOperationStruct_tAggregateRow_2 aggregated_row_tAggregateRow_2 : values_tAggregateRow_2) { // G_AggR_600
					...
					row3.nbrincomplet = (double) aggregated_row_tAggregateRow_2.count;
					row3.nbrincomplet = (double) aggregated_row_tAggregateRow_2.nbrincomplet_clmCount;
...
// # Output table : 'out1'
							out1_tmp.nbrincomplet = (row3.nbrincomplet * 100) / (row4.nbrcomplet + row3.nbrincomplet);
							out1 = out1_tmp;
// ###############################
...
///////////////////////		
							...
							if (out1.nbrincomplet != null) { //

								strBuffer_tLogRow_1.append(FormatterUtils.formatUnwithE(out1.nbrincomplet));
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final MetaDataCompletude MetaDataCompletudeClass = new MetaDataCompletude();

		int exitCode = MetaDataCompletudeClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = MetaDataCompletude.class.getClassLoader()
					.getResourceAsStream("qd_projet/metadatacompletude_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = MetaDataCompletude.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : MetaDataCompletude");
		}
...
/************************************************************************************************
 * 124003 characters generated by Talend Open Studio for Data Integration on the
 * 22 novembre 2019 12:47:29 WAT
 ************************************************************************************************/