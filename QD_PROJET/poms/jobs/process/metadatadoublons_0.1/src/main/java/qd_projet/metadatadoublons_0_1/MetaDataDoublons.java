...
package qd_projet.metadatadoublons_0_1;
...
/**
 * Job: MetaDataDoublons Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class MetaDataDoublons implements TalendJob {
	...
	private final String jobName = "MetaDataDoublons";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					MetaDataDoublons.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(MetaDataDoublons.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
		final static byte[] commonByteArrayLock_QD_PROJET_MetaDataDoublons = new byte[0];
		static byte[] commonByteArray_QD_PROJET_MetaDataDoublons = new byte[0];

		public Double TauxDoublons;

		public Double getTauxDoublons() {
			return this.TauxDoublons;
		}

		public void readData(ObjectInputStream dis) {

			synchronized (commonByteArrayLock_QD_PROJET_MetaDataDoublons) {
				...
				try {
					...
					length = dis.readByte();
					if (length == -1) {
						this.TauxDoublons = null;
					} else {
						this.TauxDoublons = dis.readDouble();
					}
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				if (this.TauxDoublons == null) {
					dos.writeByte(-1);
				} else {
					dos.writeByte(0);
					dos.writeDouble(this.TauxDoublons);
				}
		...
		public String toString() {
			...
			sb.append("[");
			sb.append("TauxDoublons=" + String.valueOf(TauxDoublons));
			sb.append("]");
	...
	public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
		...
		public Double nbUniq;

		public Double getNbUniq() {
			return this.nbUniq;
		}
		...
		public String toString() {
			...
			sb.append(super.toString());
			sb.append("[");
			sb.append("nbUniq=" + String.valueOf(nbUniq));
			sb.append("]");
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_QD_PROJET_MetaDataDoublons.length) {
					if (length < 1024 && commonByteArray_QD_PROJET_MetaDataDoublons.length == 0) {
						commonByteArray_QD_PROJET_MetaDataDoublons = new byte[1024];
					} else {
						commonByteArray_QD_PROJET_MetaDataDoublons = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_QD_PROJET_MetaDataDoublons, 0, length);
				strReturn = new String(commonByteArray_QD_PROJET_MetaDataDoublons, 0, length, utf8Charset);
			}
			return strReturn;
		}
...
// ------------
				...
				Object source_tFileInputExcel_1 = "C:/Users/ElectroTec/Desktop/Nouveau dossier/doublons.xls";
...
// Start of branch "row1"
							if (row1 != null) {
								...
								operation_result_tAggregateRow_1.nbUniq_clmCount++;
				...
				String fileName_tFileOutputExcel_1 = "C:/Users/ElectroTec/Desktop/Nouveau dossier/StatDoublons.xls";
...
//create directory only if not exists		  
				...
				if (startRowNum_tFileOutputExcel_1 == 0) {
					...
					writableSheet_tFileOutputExcel_1
							.addCell(new jxl.write.Label(0, nb_line_tFileOutputExcel_1, "TauxDoublons"));
					// modif end
					fitWidth_tFileOutputExcel_1[0] = fitWidth_tFileOutputExcel_1[0] > 12
...
// ###############################
				...
				for (AggOperationStruct_tAggregateRow_1 aggregated_row_tAggregateRow_1 : values_tAggregateRow_1) { // G_AggR_600
					...
					row3.nbUniq = (double) aggregated_row_tAggregateRow_1.count;
					row3.nbUniq = (double) aggregated_row_tAggregateRow_1.nbUniq_clmCount;
...
// # Output table : 'out1'
							out1_tmp.TauxDoublons = (row3.nbUniq / (row3.nbUniq + row4.nbDuplicate)) * 100;
							out1 = out1_tmp;
// ###############################
...
// ###############################      
	...
	public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
		...
		public Double nbDuplicate;

		public Double getNbDuplicate() {
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_QD_PROJET_MetaDataDoublons) {
				...
				try {
					...
					length = dis.readByte();
					if (length == -1) {
						this.nbDuplicate = null;
					} else {
						this.nbDuplicate = dis.readDouble();
					}
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				if (this.nbDuplicate == null) {
					dos.writeByte(-1);
				} else {
					dos.writeByte(0);
					dos.writeDouble(this.nbDuplicate);
				}
		...
		public String toString() {
			...
			sb.append(super.toString());
			sb.append("[");
			sb.append("nbDuplicate=" + String.valueOf(nbDuplicate));
			sb.append("]");
...
// ------------
				...
				Object source_tFileInputExcel_2 = "C:/Users/ElectroTec/Desktop/Nouveau dossier/sansDoublons.xls";
...
// Start of branch "row2"
							if (row2 != null) {
								...
								operation_result_tAggregateRow_2.nbDuplicate_clmCount++;
				...
				for (AggOperationStruct_tAggregateRow_2 aggregated_row_tAggregateRow_2 : values_tAggregateRow_2) { // G_AggR_600
					...
					row4.nbDuplicate = (double) aggregated_row_tAggregateRow_2.count;
					row4.nbDuplicate = (double) aggregated_row_tAggregateRow_2.nbDuplicate_clmCount;
					...
					row4_HashRow.nbDuplicate = row4.nbDuplicate;
	...
	public static void main(String[] args) {
		final MetaDataDoublons MetaDataDoublonsClass = new MetaDataDoublons();

		int exitCode = MetaDataDoublonsClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = MetaDataDoublons.class.getClassLoader()
					.getResourceAsStream("qd_projet/metadatadoublons_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = MetaDataDoublons.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : MetaDataDoublons");
		}
...
/************************************************************************************************
 * 128111 characters generated by Talend Open Studio for Data Integration on the
 * 21 novembre 2019 14:35:43 WAT
 ************************************************************************************************/